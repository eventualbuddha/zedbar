...
pub(crate) const ZBAR_CFG_ASCII: c_int = 3;
...
pub(crate) const ZBAR_ORIENT_UP: c_int = 0;
pub(crate) const ZBAR_ORIENT_RIGHT: c_int = 1;
pub(crate) const ZBAR_ORIENT_DOWN: c_int = 2;
pub(crate) const ZBAR_ORIENT_LEFT: c_int = 3;
