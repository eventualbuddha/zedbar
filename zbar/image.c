...
void zbar_image_destroy(zbar_image_t *img) { _zbar_image_refcnt(img, -1); }
...
unsigned zbar_image_get_sequence(const zbar_image_t *img) { return (img->seq); }

unsigned zbar_image_get_width(const zbar_image_t *img) { return (img->width); }
...
const void *zbar_image_get_data(const zbar_image_t *img) { return (img->data); }
